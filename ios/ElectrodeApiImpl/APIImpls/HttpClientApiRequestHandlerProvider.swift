 ...
 */
@objc public class HttpClientApiRequestHandlerProvider : RequestHandlerProvider, HttpClientApiRequestHandlerDelegate
{
    /**
     * - Parameter config : Optional config object that can be passed to an api impl provider.
     */
    init(handlerConfig: HttpClientApiConfig? = nil)
    {
        super.init(config: handlerConfig)
    }

    public func registerFetchRequestHandler()
    {
...
public class HttpClientApiConfig : RequestHandlerConfig
{
